...
declare const Base_base: {
    ...
    new (...args: any[]): {
        "__#38@#fontFamily": string | null;
        "__#38@#kerning": CanvasFontKerning | null;
        "__#38@#size": number | null;
        "__#38@#sizeUnit": "cm" | "mm" | "Q" | "in" | "pc" | "pt" | "px" | "vh" | "vw" | "em" | "cap" | "ch" | "ex" | "ic" | "lh" | "rcap" | "rch" | "rem" | "rex" | "rlh";
        "__#38@#stretch": CanvasFontStretch | null;
        "__#38@#fontStyle": ("normal" | `oblique ${number}deg` | `oblique ${number}rad` | `oblique ${number}grad` | `oblique ${number}turn` | "italic" | "oblique") | null;
        attributeChangedCallback(name: string, oldValue: string | null, newValue: string | null): void;
        fontFamily: string | null;
        fontStyle: ("normal" | `oblique ${number}deg` | `oblique ${number}rad` | `oblique ${number}grad` | `oblique ${number}turn` | "italic" | "oblique") | null;
        ...
        connectedCallback(): void;
        addEventListener<E extends keyof HTMLElementEventMap>(type: E, listener: TypedEventListener<E>, options?: boolean | AddEventListenerOptions): void;
        createChild<E extends typeof import("../mixable").CustomHTMLElement>(ElementClass: E, options?: Partial<Writeable<InstanceType<E>>> | undefined): InstanceType<E>;
        renderConicalGradient(context: CanvasRenderingContext2D, gradient: import("../../classes/gradient").ConicalGradient): CanvasGradient;
        renderLinearGradient(context: CanvasRenderingContext2D, gradient: LinearGradient): CanvasGradient;
        renderRadialGradient(context: CanvasRenderingContext2D, gradient: RadialGradient): CanvasGradient;
        removeEventListener<E extends keyof HTMLElementEventMap>(type: E, listener: TypedEventListener<E>, options?: boolean | AddEventListenerOptions): void;
        readonly changedSinceRender: boolean;
        "__#18@#handleClick"(canvas2D: Canvas2DCanvasElement): void;
        "__#18@#handleMouse"(canvas2D: Canvas2DCanvasElement): void;
        registerChange<P extends keyof /*elided*/ any>(propertyName: P, newValue: /*elided*/ any[P]): void;
...
declare class Base extends Base_base {
}
export declare class Canvas2DText extends Base {
    #private;
    ...
    set align(value: CanvasTextAlign | null);
    attributeChangedCallback(name: string, oldValue: string | null, newValue: string | null): void;
    get baseline(): CanvasTextBaseline | null;
    set baseline(value: CanvasTextBaseline | null);
    render(canvas2D: Canvas2DCanvasElement): void;
    renderLinearGradient(context: CanvasRenderingContext2D, gradient: LinearGradient): CanvasGradient;
    renderRadialGradient(context: CanvasRenderingContext2D, gradient: RadialGradient): CanvasGradient;
