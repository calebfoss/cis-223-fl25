...
declare const Canvas2DVideo_base: {
    new (...args: any[]): {
        ...
        "__#18@#handleClick"(canvas2D: import("./canvas").Canvas2DCanvasElement): void;
        "__#18@#handleMouse"(canvas2D: import("./canvas").Canvas2DCanvasElement): void;
...
declare const HTMLVideoWrapper_base: {
    new (...args: any[]): {
        "__#40@#element": HTMLVideoElement;
