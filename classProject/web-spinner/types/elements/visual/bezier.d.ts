...
declare const Canvas2DShapeBezier_base: {
    new (...args: any[]): {
        "__#34@#controlA": Vector2D;
        "__#34@#controlB": Vector2D;
        /**
...
export declare class Canvas2DShapeBezier extends Canvas2DShapeBezier_base {
    static get tag(): "c2d-shape-bezier";
    render(canvas2D: Canvas2DCanvasElement): void;
}
declare const Canvas2DBezier_base: {
    new (...args: any[]): {
        render(canvas2D: Canvas2DCanvasElement): void;
        afterRender(canvas2D: Canvas2DCanvasElement): void;
...
export declare class Canvas2DBezier extends Canvas2DBezier_base {
