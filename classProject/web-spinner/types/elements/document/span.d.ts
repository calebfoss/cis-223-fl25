...
declare const DocumentSpanWrapper_base: {
    new (...args: any[]): {
        ...
        paragraph(options?: Options<import("./paragraph").DocumentParagraphController>): import("./paragraph").DocumentParagraphController;
...
export declare class DocumentSpanWrapper extends DocumentSpanWrapper_base {
}
export type DocumentSpanController = HTMLElementController<"span", DocumentSpanWrapper>;
export {};
