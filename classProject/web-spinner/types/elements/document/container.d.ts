...
declare const DocumentContainerWrapper_base: {
    new (...args: any[]): {
...
export declare class DocumentContainerWrapper extends DocumentContainerWrapper_base {
}
export type DocumentContainerController = HTMLElementController<"div", DocumentContainerWrapper>;
export {};
