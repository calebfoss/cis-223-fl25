...
import { Canvas2DBaseRenderable, Canvas2DShapePartRenderable, Canvas2DStandaloneRenderable } from "../elements/visual/renderable";
...
declare function c2dTransform<B extends ReturnType<typeof baseTransform<typeof Canvas2DBaseRenderable>>>(Base: B): {
    new (...args: any[]): {
...
declare const C2DStandaloneTransformed_base: {
    new (...args: any[]): {
        render(canvas2D: Canvas2DCanvasElement): void;
        afterRender(canvas2D: Canvas2DCanvasElement): void;
        "__#22@#anchor": Vector2D;
    ...
    observedAttributes: string[];
    tag: string;
} & typeof Canvas2DStandaloneRenderable;
export declare class C2DStandaloneTransformed extends C2DStandaloneTransformed_base {
}
declare const C2DShapePartTransformed_base: {
    new (...args: any[]): {
        render(canvas2D: Canvas2DCanvasElement): void;
        afterRender(canvas2D: Canvas2DCanvasElement): void;
        "__#22@#anchor": Vector2D;
    ...
    observedAttributes: string[];
    tag: string;
} & typeof Canvas2DShapePartRenderable;
export declare class C2DShapePartTransformed extends C2DShapePartTransformed_base {
}
