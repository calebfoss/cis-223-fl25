...
export declare function offset<B extends typeof CustomHTMLElement>(Base: B): {
    new (...args: any[]): {
        "__#27@#offset": Vector2D;
        attributeChangedCallback(name: string, oldValue: string | null, newValue: string | null): void;
        moveOffset(x: number, y: number): void;
        "__#27@#offsetChangeListener": ChangeListener<Vector2DBase>;
        /**
...
export declare function extendSVGOffset<B extends SVGElementController & ReturnType<typeof offset>>(Base: B): {
    new (...args: any[]): {
...
export declare function svgOffset<B extends SVGElementController>(Base: B): {
    new (...args: any[]): {
        connectedCallback(): void;
        moveOffset(x: number, y: number): void;
        offset: Vector2D;
