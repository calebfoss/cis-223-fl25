...
export declare function extendSVGDimensions<B extends SVGElementController & ReturnType<typeof dimensions>>(Base: B): {
    new (...args: any[]): {
...
export declare function svgDimensions<B extends SVGElementController>(Base: B): {
    new (...args: any[]): {
        connectedCallback(): void;
        height: number;
        width: number;
