import { ConicalGradient, DrawStyle, Gradient, LinearGradient, RadialGradient } from "../classes/gradient";
...
export declare function c2dFill<B extends typeof Canvas2DBaseRenderable>(Base: B): {
    new (...args: any[]): {
        render(canvas2D: Canvas2DCanvasElement): void;
        afterRender(canvas2D: Canvas2DCanvasElement): void;
        "__#30@#fill": DrawStyle | null;
        /**
...
export declare function svgFill<B extends SVGElementController>(Base: B): {
    new (...args: any[]): {
        connectedCallback(): void;
        fill: DrawStyle | null;
        "__#31@#fillGradient"(gradient: Gradient): void;
