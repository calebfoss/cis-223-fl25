...
export declare function c2dRectangleBounds<B extends typeof Canvas2DBaseRenderable>(Base: B, defaultOrigin: Origin): {
    new (...args: any[]): {
        ...
        renderRadialGradient(context: CanvasRenderingContext2D, gradient: import("../classes/gradient").RadialGradient): CanvasGradient;
        readonly changedSinceRender: boolean;
        "__#18@#handleClick"(canvas2D: import("../elements/visual/canvas").Canvas2DCanvasElement): void;
        "__#18@#handleMouse"(canvas2D: import("../elements/visual/canvas").Canvas2DCanvasElement): void;
...
export declare function svgRectangleBounds<B extends SVGElementController>(Base: B, defaultOrigin: Origin): {
    new (...args: any[]): {
        _updateOffset(): void;
        origin: Origin;
