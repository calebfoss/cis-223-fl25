...
import { ConicalGradient, DrawStyle, Gradient, RadialGradient } from "../classes/gradient";
...
export declare function c2dStroke<B extends typeof Canvas2DBaseRenderable>(Base: B): {
    new (...args: any[]): {
        render(canvas2D: Canvas2DCanvasElement): void;
        afterRender(canvas2D: Canvas2DCanvasElement): void;
        "__#23@#stroke": DrawStyle | null;
...
export declare function svgStroke<B extends SVGElementController>(Base: B): {
    new (...args: any[]): {
        connectedCallback(): void;
        lineWidth: number | null;
        stroke: DrawStyle | null;
        "__#24@#strokeGradient"(gradient: Gradient): void;
